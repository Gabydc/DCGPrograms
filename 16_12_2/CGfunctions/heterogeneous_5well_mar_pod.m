...
dir='/home/wagm/cortes/Localdisk/Results/16_07/POD/';
...
folder=['size_'   num2str(size) 'perm_' num2str(per) '_5wells' num2str(k)  ];
mkdir([dir], folder)
dir = [dir folder '/'];
...
%[x11m,fl0,rr0,it0,rv0] = pcg(a,b',tol,iteration,l,l',xi');
