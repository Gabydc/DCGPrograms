...
function solve_DICCG_f_pod(num,nn,e,iteration,dir,k)
...
[x4,iter4,e4,hl4,h2,h21]=DICCG(a,b,xi,iteration,tol,z,l,e,text1,nn,dir,def,fc);
[x41,fl2,rr2,it2,rv2] = dpcg(a,b,z,10^-9,200,l,l',xi);

 [x5,iter5,e5,hl5,h2,h21]=DICCG_1(a,b,xi,iteration,tol,z1,l,e,text1,nn,dir,def,fc);
%[x6,iter6,e6,hl6,h26,h216]=DICCG_2e(a,b,xi,iteration,tol,zp,l,e,text1,nn,dir,def,fc);
  figure

semilogy(rv1./norm(b),'b.');hold on
...
figure(fc)
legend([hl2,hl4,hl5],'ICCG','DICCG','DICG_{pod}')
...
% 
 ...
 %colorbar
 view(0,90)
 h1d=plotingsolution(G,W,'DICCG_{m}',x41,2);
view(0,90)
 figure(fc+2)
 h1=plotingsolution(G,W,'ICCG',x2,1);
 %colorbar
 view(0,90)
 h1=plotingsolution(G,W,'ICCG_m',x21,2);
% colorbar
view(0,90)
% figure(fc+3)
% %h1=plotingsolution(G,W,'CG',x1,1);
