...
e=0;
num='5';
 %dir='/home/wagm/cortes/Localdisk/Results/16_04/04_13/';
 nxi=1;
 nyi=1;
 nx=60;
 ny=220;
...
%dir='/home/wagm/cortes/Localdisk/Research_programs/2016_1_report/1_18_results/';
 dir='/home/wagm/cortes/Localdisk/Results/16_06/06/';
...
%inhomogeneus permeability
 ...
 %Visualize the plot
  hp=plotCellData(G, log(perm)); break
%  
  view(50,40) 
%  file='perm';
  axis equal tight
...
solve_DICCG_f_pod(num,nn,e,2000,dir,11);
