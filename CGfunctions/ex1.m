...
G          = computeGeometry(G);
rock.perm(1:100)  = repmat(1*darcy(), [100, 1]);
rock.perm(101:200)  = repmat(0.1*darcy(), [100, 1]);
rock.perm(201:300)  = repmat(0.01*darcy(), [100, 1]);
rock.perm(301:400)  = repmat(0.001*darcy(), [100, 1]);
